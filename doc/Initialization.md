...
| Specific version of ImageJ2                              | `ij = imagej.init('2.11.0')`                                                        | YES           |
| Specific version of ImageJ2 (no original ImageJ)         | `ij = imagej.init('2.11.0', add_legacy=False)`                                      | YES           |
| With a GUI (newest version, blocking)                    | `ij = imagej.init(mode='gui')`                                                      | NO            |
| With a GUI (specific version, blocking)                  | `ij = imagej.init('net.imagej:imagej:2.11.0', mode='gui')`                          | YES           |
| With a GUI (newest version, interactive)                 | `ij = imagej.init(mode='interactive')`                                              | NO            |
| With a GUI (specific version, interactive)               | `ij = imagej.init('net.imagej:imagej:2.11.0', mode='interactive')`                  | YES           |
| With Fiji plugins (newest version)                       | `ij = imagej.init('sc.fiji:fiji')`                                                  | NO            |
| With Fiji plugins (specific version)                     | `ij = imagej.init('sc.fiji:fiji:2.11.0')`                                           | YES           |
| With a specific plugin (newest version)                  | `ij = imagej.init(['net.imagej:imagej', 'net.preibisch:BigStitcher'])`              | NO            |
| With a specific plugin (specific version)                | `ij = imagej.init(['net.imagej:imagej:2.11.0', 'net.preibisch:BigStitcher:0.4.1'])` | YES           |
...
```python
import imagej
ij = imagej.init('sc.fiji:fiji:2.11.0')
```
...
```python
import imagej
ij =imagej.init(['net.imagej:imagej:2.11.0', 'net.preibisch:BigStitcher:1.1.0'])
```
